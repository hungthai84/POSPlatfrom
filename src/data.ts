...
export const INITIAL_PRODUCTS: Product[] = [
  {
    id: "p-1",
    sku: "000002",
    name: "Áo Thun Power Service Unisex Premium",
    category: "Thời trang",
    image:
    ...
    isActive: true,
    description:
      "Áo thun cotton 100% co giãn 4 chiều, thoáng mát, giữ form tốt.",
    totalImport: 50,
    totalAvailable: 37,
    totalShipping: 13,
    variants: [
      {
        id: "v-1-1",
        sku: "000002-W-M",
        name: "Áo Thun Power Service - Trắng / M",
        productId: "p-1",
        price: 250000,
        importPrice: 120000,
        stock: 25,
      ...
      },
      {
        id: "v-1-2",
        sku: "000002-B-L",
        name: "Áo Thun Power Service - Đen / L",
        productId: "p-1",
        price: 250000,
        importPrice: 120000,
        stock: 25,
  ...
  },
  {
    id: "p-2",
    sku: "000001",
    name: "Quần Jean Slimfit Power Service",
    category: "Thời trang",
    image:
  ...
  },
  {
    id: "p-3",
    sku: "000003",
    name: "Bình Giữ Nhiệt Power Service Inox 304",
    category: "Gia dụng",
    image:
      "https://images.unsplash.com/photo-1602143407151-7111542de6e8?auto=format&fit=crop&q=80&w=200",
    isActive: true,
    description:
      "Bình giữ nhiệt 500ml cao cấp, giữ nhiệt nóng lạnh đến 24 giờ.",
    totalImport: 100,
    totalAvailable: 85,
    totalShipping: 15,
    variants: [
      {
        id: "v-3-1",
        sku: "000003-SL",
        name: "Bình Giữ Nhiệt Power Service - Bạc",
        productId: "p-3",
        price: 180000,
        importPrice: 80000,
        stock: 50,
      ...
      },
      {
        id: "v-3-2",
        sku: "000003-BK",
        name: "Bình Giữ Nhiệt Power Service - Đen nhám",
        productId: "p-3",
        price: 180000,
        importPrice: 80000,
        stock: 50,
  ...
  },
  {
    id: "p-4",
    sku: "000004",
    name: "Balo Du Lịch Power Service Smart Voyager",
    category: "Phụ kiện",
    image:
      "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&q=80&w=200",
    isActive: true,
    description:
      "Balo chống nước, tích hợp cổng sạc USB và ngăn chứa laptop 15.6 inch.",
    totalImport: 30,
    totalAvailable: 25,
    totalShipping: 5,
    variants: [
  ...
  },
  {
    id: "p-5",
    sku: "000005",
    name: "Tai Nghe Không Dây Power Service Buds",
    category: "Điện tử",
    image:
      "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?auto=format&fit=crop&q=80&w=200",
    isActive: true,
    description:
      "Tai nghe Bluetooth 5.3, chống ồn chủ động ANC, pin lên đến 30h.",
    totalImport: 40,
    totalAvailable: 35,
    totalShipping: 5,
    variants: [
      {
        id: "v-5-1",
        sku: "000005-WH",
        name: "Power Service Buds - Trắng Tuyết",
        productId: "p-5",
        price: 990000,
        importPrice: 450000,
        stock: 20,
      ...
      },
      {
        id: "v-5-2",
        sku: "000005-BL",
        name: "Power Service Buds - Đen Huyền Bí",
        productId: "p-5",
        price: 990000,
        importPrice: 450000,
        stock: 20,
...
export const INITIAL_CUSTOMERS: Customer[] = [
  ...
  {
    id: "c-3",
    name: "Công ty TNHH Power Service",
    phone: "0243999888",
    email: "info@powerservice.vn",
    ...
    items: [
      {
        productId: "p-1",
        variantId: "v-1-1",
        productName: "Áo Thun Power Service Unisex Premium",
        variantName: "Áo Thun Power Service - Trắng / M",
        sku: "000002-W-M",
        price: 250000,
        quantity: 2,
      },
      {
        productId: "p-3",
        variantId: "v-3-1",
        productName: "Bình Giữ Nhiệt Power Service Inox 304",
        variantName: "Bình Giữ Nhiệt Power Service - Bạc",
        sku: "000003-SL",
        price: 180000,
        quantity: 1,
      },
    ...
    items: [
      {
        productId: "p-5",
        variantId: "v-5-2",
        productName: "Tai Nghe Không Dây Power Service Buds",
        variantName: "Power Service Buds - Đen Huyền Bí",
        sku: "000005-BL",
        price: 990000,
        quantity: 1,
      },
    ...
    items: [
      {
        ...
        variantId: "v-1-2",
        productName: "Áo Thun Power Service Unisex Premium",
        variantName: "Áo Thun Power Service - Đen / L",
        sku: "000002-B-L",
        price: 250000,
        quantity: 10,
      },
      {
        productId: "p-4",
        variantId: "v-4-1",
        productName: "Balo Du Lịch Power Service Smart Voyager",
    ...
    items: [
      {
        ...
        variantId: "v-3-2",
        productName: "Bình Giữ Nhiệt Power Service Inox 304",
        variantName: "Bình Giữ Nhiệt Power Service - Đen nhám",
        sku: "000003-BK",
        price: 180000,
        quantity: 3,
      },
    ...
    items: [
      {
        ...
        variantName: "Giày Bóng Rổ Power Service - Trắng / 42",
        sku: "000001-W-42",
        price: 1200000,
        quantity: 1,
      },
...
export const INITIAL_LIVESTREAMS: any[] = [
  {
    ...
    comments: [
      ...
      },
      {
        ...
        userId: "u2",
        userName: "Trần Thị B",
        content: "Có size cho 60kg không shop?",
        timestamp: new Date().toISOString(),
        isOrder: false,
      },
      {
...
export const INITIAL_CALLS: any[] = [
  {
    ...
    phone: "0912123456",
    reason: "Tư vấn combo Hè",
    scheduledAt: "2026-06-14T09:00:00Z",
    status: "pending",
    notes: "Khách quan tâm đồ gia dụng",
  },
  {
    id: "CAL-002",
    customerName: "Hoàng Oanh",
    phone: "0988777666",
    reason: "Chăm sóc sau mua",
    scheduledAt: "2026-06-13T14:30:00Z",
    status: "completed",
  },
];

export const DEFAULT_CONFIG: ShopConfig = {
  name: "Power Service POS Platfrom",
  phone: "0987 654 321",
  address: "Power Service Building, 15 Tố Hữu, Nam Từ Liêm, Hà Nội",
  email: "contact@powerservice.vn",
  logoUrl: "https://i.ibb.co/WW0K15Xz/Logo-mau-xanh-x-m-CV-Nguyen-H-ng-Th-i.png",
  currency: "đ",
  taxRate: 0.1, // 10% VAT
  lowStockThreshold: 5,
};
