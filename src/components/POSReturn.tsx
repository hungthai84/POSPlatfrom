    ...
    <div className="flex flex-col h-screen bg-[#f1f3f5] overflow-hidden select-none font-sans text-slate-800">
      ...
      <div className="flex items-center px-4 bg-white border-b border-slate-200 h-12 shrink-0 gap-2">
        <div className="flex items-center gap-1 overflow-x-auto scrollbar-none flex-1">
          <div className="flex items-center gap-2 px-4 h-9 rounded-t-lg border-x border-t transition-all cursor-pointer text-[14px] font-bold whitespace-nowrap bg-[#f1f3f5] border-slate-200 text-blue-600">
            <span>Trả hàng</span>
          </div>
      ...
      <div className="flex-1 overflow-y-auto p-3 flex gap-3 min-h-0">
        ...
        <div className="flex-[7] flex flex-col gap-3 min-w-0">
          ...
          <div className="bg-white rounded-lg p-4 flex flex-col gap-4 shadow-sm border border-slate-200">
            <div className="flex items-center justify-between gap-4">
              <h4 className="font-bold text-[16px]">Trả hàng</h4>
              <div className="flex items-center gap-2">
                <div className="relative group">
                  <select className="bg-slate-100 border border-transparent rounded-lg px-3 py-1.5 text-[14px] font-bold appearance-none pr-8">
                ...
                <div className="relative group">
                  <div className="flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-lg">
                    <Box size={16} />
                    <select className="bg-transparent border-none p-0 text-[14px] font-bold appearance-none pr-6">
            ...
            <div className="min-h-[160px] border border-slate-100 rounded-xl flex flex-col items-center justify-center text-slate-400 bg-white">
              ...
              <span className="text-[14px] font-medium">Giỏ hàng trống</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 flex flex-col gap-4 shadow-sm border border-slate-200">
            <div className="flex items-center justify-between gap-4">
              <h4 className="font-bold text-[16px]">Đơn đổi hàng</h4>
              <div className="flex items-center gap-2">
                <div className="relative group">
                  <select className="bg-slate-100 border border-transparent rounded-lg px-3 py-1.5 text-[14px] font-bold appearance-none pr-8 text-slate-500">
                ...
                <div className="relative group">
                  <div className="flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-lg text-slate-500">
                    <Box size={16} />
                    <select className="bg-transparent border-none p-0 text-[14px] font-bold appearance-none pr-6 text-slate-500">
                      <option>Kho mặc định</option>
                    </select>
                    <ChevronDown
                      size={14}
              ...
              <div className="relative flex-1">
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2 text-slate-400">
                  <div className="flex items-center gap-1 border-r border-slate-300 pr-2 mr-1">
                    <input
                      type="checkbox"
                      className="rounded text-blue-600 border-slate-300 mr-1"
                    />
          ...
          <div className="grid grid-cols-2 gap-3 pb-8">
            ...
            <div className="bg-white rounded-lg p-4 space-y-4 shadow-sm border border-slate-200">
              <h4 className="font-bold text-[16px]">Thông tin trả hàng</h4>

              <div className="space-y-3">
                <div className="flex items-center justify-between gap-3">
                  <span className="text-[14px] font-medium text-slate-700">
                    Giảm giá đơn trả hàng
                  </span>
                  <div className="w-32 bg-slate-100 rounded px-2 py-1 flex items-center justify-end">
                    <span className="text-[14px] font-bold text-slate-900 mr-1">
                      0
                    </span>
                    <span className="text-[14px] font-bold underline">đ</span>
                  </div>
                </div>
                <div className="flex items-center justify-between gap-3">
                  <span className="text-[14px] font-medium text-slate-700">
                  ...
                  <div className="relative w-32">
                    <input
                      type="text"
                      className="w-full bg-slate-100 rounded px-2 py-1 text-[14px] font-bold text-slate-900 text-right pr-6"
                      value="0"
                      readOnly
                    />
                    <span className="absolute right-2 top-1/2 -translate-y-1/2 text-[14px] font-bold underline pointer-events-none">
                      đ
                    </span>
                  </div>
                </div>
        ...
        <div className="flex-[4] flex flex-col gap-3 min-w-0 pb-[80px]">
          ...
          <div className="bg-white rounded-lg p-4 space-y-4 shadow-sm border border-slate-200">
            <div className="flex items-center justify-between">
              <h4 className="font-bold text-[16px]">Trạng thái</h4>
              <input
                type="text"
                placeholder="Mã tùy chỉnh"
                className="bg-slate-50 border border-slate-100 rounded p-1.5 text-[14px] w-28 text-slate-600"
              />
            </div>
            ...
            <div className="space-y-3 text-[14px]">
              ...
              <div className="pt-1">
                <button className="text-[12px] font-bold border border-slate-200 hover:bg-slate-50 rounded px-2 py-1">
                  Thêm thẻ
                </button>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg p-4 space-y-4 shadow-sm border border-slate-200">
            ...
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                className="bg-slate-50 border border-transparent rounded px-3 py-2 text-[14px] focus:bg-white focus:border-blue-500"
              />
              <input
                type="text"
            ...
            <div className="bg-[#f0f6fc] border border-blue-100 text-slate-700 rounded-lg p-2.5 flex justify-center items-center gap-1.5 text-[14px] font-medium">
              <Info size={14} />
          ...
          <div className="bg-white rounded-lg p-4 space-y-3 shadow-sm border border-slate-200">
            <div className="flex items-center justify-between mb-1">
              ...
              <div className="relative">
                <select className="bg-slate-50 border border-none rounded px-3 py-1.5 text-[14px] font-medium appearance-none pr-6 text-slate-600 min-w-28 text-right">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center bg-slate-50 border border-none rounded px-3 py-1.5 text-[14px] text-slate-500">
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <input
                ...
                className="col-span-1 bg-slate-50 border border-transparent rounded px-3 py-2 text-[14px] focus:bg-white focus:border-blue-500"
              />
              <input
                type="text"
                placeholder="Số điện thoại"
              ...
              <input
                ...
                className="col-span-2 bg-slate-50 border border-transparent rounded px-3 py-2 text-[14px] focus:bg-white focus:border-blue-500"
              />

              <div className="col-span-2 relative">
                <select className="w-full bg-slate-50 border border-none rounded px-3 py-2 text-[14px] font-medium appearance-none text-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                  <option>Chọn địa chỉ</option>
                </select>
                <ChevronDown
                  size={14}
          ...
          <div className="bg-white rounded-lg p-4 space-y-3 shadow-sm border border-slate-200 mb-6">
            <div className="flex items-center justify-between mb-1">
              ...
              <div className="relative">
                <select className="bg-slate-50 border border-none rounded px-3 py-1.5 text-[14px] font-medium appearance-none pr-6 text-slate-600 text-right">
            ...
            <div className="flex items-center justify-between text-[14px] text-slate-700">
              ...
              <div className="flex items-center gap-1 font-mono">
                <input
                  type="text"
                  className="w-8 bg-slate-50 rounded px-1.5 py-1 text-center font-semibold text-slate-600"
                  value="0"
                  readOnly
                />{" "}
                <span>x</span>
                ...
                <input
                  ...
                  readOnly
                />{" "}
                <span className="ml-1 text-[12px]">(cm)</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-16 xl:left-60 right-0 bg-white border-t border-slate-200 px-4 py-3 flex items-center justify-between shadow-[0_-4px_10px_-4px_rgba(0,0,0,0.05)] z-20 transition-all duration-300">
        <div className="flex flex-col gap-0.5">
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-[16px] font-bold text-slate-900">0 đ</span>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-[16px] font-semibold text-slate-700">
              COD:
            </span>
            <span className="text-[16px] font-bold text-red-600">0 đ</span>
          </div>
        </div>

        <div className="flex items-center gap-3">
          <div className="bg-white border border-teal-300 px-4 py-2 rounded-lg text-teal-600 text-[14px] font-bold shadow-sm">
            Trạng thái: Mới
          </div>
          <button className="bg-white border border-slate-300 hover:bg-slate-50 px-4 py-2 rounded-lg text-slate-700 text-[14px] font-bold flex items-center gap-2 shadow-sm transition">
            <Printer size={16} />
            <span>In (F4)</span>
          </button>
          <button className="bg-[#0f62fe] hover:bg-blue-700 px-6 py-2 rounded-lg text-white text-[14px] font-bold flex items-center gap-2 shadow-md transition">
            <Save size={16} />
            <span>Lưu (F2)</span>
          </button>
        </div>
